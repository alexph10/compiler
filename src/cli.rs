...
#[derive(Parser, Debug)]
#[command(name = "poc", about = "polyglot build compiler")]
pub struct Cli{ 
    #[command(subcommand)]
    pub command: Command,
...
pub enum Command {
    Build {
        ...
        test: bool,
        #[arg(short, long, help = "Run the build artifact")]
        run: bool, 
...
impl Cli {
    pub fn generate_completions(shell: clap_complete::Shell) {
        clap_complete::generate(shell, &mut Self::command(), "compiler", &mut std::io::stdout());
    }
}